...
export class QuestionsAndAnswersComponent {
  ...
  QuestionOne: boolean = false;
  QuestionTwo: boolean = false;
  QuestionThree: boolean = false;
  QuestionFour: boolean = false;
  QuestionFive: boolean = false;
  QuestionSix: boolean = false;
  QuestionSeven: boolean = false;
  QuestionEight: boolean = false;
  QuestionNine: boolean = false;
  QuestionTen: boolean = false;
  ...
  highlight(option: SelectOption) {
    this.selectedIndex = this.optionArray.indexOf(option);
  }
}
